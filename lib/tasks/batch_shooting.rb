class Tasks::BatchShooting
    def self.execute
        require 'open-uri'
        require 'nokogiri'

        url = 'http://search.jp.playstation.com/search?site=FIZ02WOB&sort=1&design=2&group=1&charset=UTF-8&ps4Disk=1&ps4Download=1&genre=5&period1=0&period3=0&onsaleAndSoon=1&count=100#search-result'

class Tasks::BatchGame2
    def self.execute
        require 'open-uri'
        require 'nokogiri'

        url = 'http://search.jp.playstation.com/search?charset=UTF-8&count=100&onsaleAndSoon=0&site=FIZ02WOB&design=2&period3=0&ps4Disk=1&period1=0&ps4Download=0&group=1&sort=1&genre=2#search-result'
